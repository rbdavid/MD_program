...
void write_log_step(int iter, FILE *logOut, char *logFileName, char *trajFileName, char *velFileName, char *forFileName, int nAtoms, double temp, int nIter, double delta_t, int deltaWrite, double cutoff, double Ar_m, double Ar_eps, double Ar_sigma, double kBT, double box, double Tot_en, double Tot_potential_en, double Tot_kinetic_en, double int_temp) {
